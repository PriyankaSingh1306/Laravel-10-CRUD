...
<html lang="en">
  ...
  <body>
    ...
    <div class="bg-dark py-3">
      <h3 class="text-white text-center">Simple Laravel 10 CRUD</h3>
    </div>
    <div class="container">
        ...
        <div class="col-md-10">
          ...
          <div class="card-body">
            ...
            <div class="mb-3">
              ...
              <textarea  class="form-control" placeholder="Description" name="description" cols="30" row="5">{{ old('description',$product->description) }}</textarea>
            </div>
            <div class="mb-3">
              ...
              @if ($product->image != "")
                <img width="w-50" class="my-3" src="{{ asset('uploads/products/' . $product->image) }}" alt="">
